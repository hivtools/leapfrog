...
type
  ...
  private
    ...
    curedPropAll: PDouble;
    curedPropAllLength: Integer;
    popHivNeg: PDouble;
...
type
  ...
  public
    ...
    curedPropAll: TGBFixedArray<Double>;
...
begin;
  ...
  Result.curedPropAll := PDouble(curedPropAll.data);
  Result.curedPropAllLength := curedPropAll.GetLength();
