...
type
  ...
  private
    ...
    cotrimValIsPercent: PInteger;
    cotrimValIsPercentLength: Integer;
    ...
    fertInfections: PDouble;
    fertInfectionsLength: Integer;
    fertHivnpop: PDouble;
    fertHivnpopLength: Integer;
    totalBirths: PDouble;
    totalBirthsLength: Integer;
    pbfwPrepClients: PDouble;
    pbfwPrepClientsLength: Integer;
    pbfwPrepIsPercent: PInteger;
    pbfwPrepIsPercentLength: Integer;
    pbfwPrepAdherenceDailyOral: Double;
    pbfwPrepAdherenceDailyOralLength: Integer;
    pbfwPrepAdherenceInjectable: Double;
    pbfwPrepAdherenceInjectableLength: Integer;
    pbfwPrepClientIncidenceRatio: Double;
    pbfwPrepClientIncidenceRatioLength: Integer;
    pbfwPrepPersonYearsDailyOral: Double;
    pbfwPrepPersonYearsDailyOralLength: Integer;
    pbfwPrepPersonYearsInjectable: Double;
    pbfwPrepPersonYearsInjectableLength: Integer;
    cotrimEffect: PDouble;
    cotrimEffectLength: Integer;
    hcArtStart: Integer;
...
type
  ...
  public
    ...
    cotrimVal: TGBFixedArray<Double>;
    ...
    cotrimValIsPercent: TGBFixedArray<Integer>;
    ...
    fertInfections: TGBFixedArray<Double>;
    fertHivnpop: TGBFixedArray<Double>;
    totalBirths: TGBFixedArray<Double>;
    pbfwPrepClients: TGBFixedArray<Double>;
    pbfwPrepIsPercent: TGBFixedArray<Integer>;
    pbfwPrepAdherenceDailyOral: Double;
    pbfwPrepAdherenceInjectable: Double;
    pbfwPrepClientIncidenceRatio: Double;
    pbfwPrepPersonYearsDailyOral: Double;
    pbfwPrepPersonYearsInjectable: Double;
    cotrimEffect: TGBFixedArray<Double>;
    hcArtStart: Integer;
...
type
  ...
  public
    ...
    cotrimNeed: TGBFixedArray<Double>;
...
type
  ...
  private
    ...
    rnCureCoverageChildren: PDouble;
    rnCureCoverageChildrenLength: Integer;
    ...
    therapeuticVacCov: PDouble;
    therapeuticVacCovLength: Integer;
    therapeuticVacDuration: Double;
    therapeuticVacDurationLength: Integer;
    therapeuticVacReduceInf: Double;
    therapeuticVacReduceInfLength: Integer;
    therapeuticVacReduceMort: Double;
    therapeuticVacReduceMortLength: Integer;
    funcCureHrCov: PDouble;
    funcCureHrCovLength: Integer;
    funcCureLrCov: PDouble;
    funcCureLrCovLength: Integer;
    funcCureChildrenCov: PDouble;
    funcCureChildrenCovLength: Integer;
    funcCureReduceInf: Double;
    funcCureReduceInfLength: Integer;
    funcCureReduceMort: Double;
    funcCureReduceMortLength: Integer;
    funcCureDuration: Double;
    funcCureDurationLength: Integer;
end;
...
type
  ...
  public
    ...
    rnCureCoverageChildren: TGBFixedArray<Double>;
    rnCureCoverageType: Integer;
    ...
    therapeuticVacCov: TGBFixedArray<Double>;
    therapeuticVacDuration: Double;
    therapeuticVacReduceInf: Double;
    therapeuticVacReduceMort: Double;
    funcCureHrCov: TGBFixedArray<Double>;
    funcCureLrCov: TGBFixedArray<Double>;
    funcCureChildrenCov: TGBFixedArray<Double>;
    funcCureReduceInf: Double;
    funcCureReduceMort: Double;
    funcCureDuration: Double;
...
type
  ...
  private
    ...
    propCuredAll: PDouble;
    propCuredAllLength: Integer;
    propCuredRg: PDouble;
    propCuredRgLength: Integer;
    propCuredChildren: PDouble;
    propCuredChildrenLength: Integer;
    propCuredNeonates: PDouble;
    propCuredNeonatesLength: Integer;
    propFuncCuredHr: PDouble;
    propFuncCuredHrLength: Integer;
    propFuncCuredLr: PDouble;
    propFuncCuredLrLength: Integer;
    propFuncCuredChildren: PDouble;
    propFuncCuredChildrenLength: Integer;
    propTherapeuticallyVaccinated: PDouble;
    propTherapeuticallyVaccinatedLength: Integer;
    curedProp: PDouble;
    curedPropLength: Integer;
    totalNewCures: PDouble;
    totalNewCuresLength: Integer;
end;
...
type
  ...
  public
    ...
    propCuredAll: TGBFixedArray<Double>;
    propCuredRg: TGBFixedArray<Double>;
    propCuredChildren: TGBFixedArray<Double>;
    propCuredNeonates: TGBFixedArray<Double>;
    propFuncCuredHr: TGBFixedArray<Double>;
    propFuncCuredLr: TGBFixedArray<Double>;
    propFuncCuredChildren: TGBFixedArray<Double>;
    propTherapeuticallyVaccinated: TGBFixedArray<Double>;
    curedProp: TGBFixedArray<Double>;
    totalNewCures: TGBFixedArray<Double>;
...
begin;
  ...
  fertHivnpop.Free;
  totalBirths.Free;
  pbfwPrepClients.Free;
  pbfwPrepIsPercent.Free;
  cotrimEffect.Free;
...
begin;
  ...
  Result.cotrimVal := PDouble(cotrimVal.data);
  Result.cotrimValLength := cotrimVal.GetLength();
  ...
  Result.cotrimValIsPercent := PInteger(cotrimValIsPercent.data);
  Result.cotrimValIsPercentLength := cotrimValIsPercent.GetLength();
  ...
  Result.fertInfections := PDouble(fertInfections.data);
  Result.fertInfectionsLength := fertInfections.GetLength();
  Result.fertHivnpop := PDouble(fertHivnpop.data);
  Result.fertHivnpopLength := fertHivnpop.GetLength();
  Result.totalBirths := PDouble(totalBirths.data);
  Result.totalBirthsLength := totalBirths.GetLength();
  Result.pbfwPrepClients := PDouble(pbfwPrepClients.data);
  Result.pbfwPrepClientsLength := pbfwPrepClients.GetLength();
  Result.pbfwPrepIsPercent := PInteger(pbfwPrepIsPercent.data);
  Result.pbfwPrepIsPercentLength := pbfwPrepIsPercent.GetLength();
  Result.pbfwPrepAdherenceDailyOral := pbfwPrepAdherenceDailyOral;
  Result.pbfwPrepAdherenceDailyOralLength := 1;
  Result.pbfwPrepAdherenceInjectable := pbfwPrepAdherenceInjectable;
  Result.pbfwPrepAdherenceInjectableLength := 1;
  Result.pbfwPrepClientIncidenceRatio := pbfwPrepClientIncidenceRatio;
  Result.pbfwPrepClientIncidenceRatioLength := 1;
  Result.pbfwPrepPersonYearsDailyOral := pbfwPrepPersonYearsDailyOral;
  Result.pbfwPrepPersonYearsDailyOralLength := 1;
  Result.pbfwPrepPersonYearsInjectable := pbfwPrepPersonYearsInjectable;
  Result.pbfwPrepPersonYearsInjectableLength := 1;
  Result.cotrimEffect := PDouble(cotrimEffect.data);
  Result.cotrimEffectLength := cotrimEffect.GetLength();
...
begin;
  ...
  Result.cotrimNeed := PDouble(cotrimNeed.data);
  Result.cotrimNeedLength := cotrimNeed.GetLength();
...
begin;
  ...
  therapeuticVacCov.Free;
  funcCureHrCov.Free;
  funcCureLrCov.Free;
  funcCureChildrenCov.Free;
  inherited;
end;
...
begin;
  ...
  propCuredAll.Free;
  propCuredRg.Free;
  propCuredChildren.Free;
  propCuredNeonates.Free;
  propFuncCuredHr.Free;
  propFuncCuredLr.Free;
  propFuncCuredChildren.Free;
  propTherapeuticallyVaccinated.Free;
  curedProp.Free;
  totalNewCures.Free;
  inherited;
end;
...
begin;
  ...
  Result.rnCureCoverageChildren := PDouble(rnCureCoverageChildren.data);
  Result.rnCureCoverageChildrenLength := rnCureCoverageChildren.GetLength();
  ...
  Result.therapeuticVacCov := PDouble(therapeuticVacCov.data);
  Result.therapeuticVacCovLength := therapeuticVacCov.GetLength();
  Result.therapeuticVacDuration := therapeuticVacDuration;
  Result.therapeuticVacDurationLength := 1;
  Result.therapeuticVacReduceInf := therapeuticVacReduceInf;
  Result.therapeuticVacReduceInfLength := 1;
  Result.therapeuticVacReduceMort := therapeuticVacReduceMort;
  Result.therapeuticVacReduceMortLength := 1;
  Result.funcCureHrCov := PDouble(funcCureHrCov.data);
  Result.funcCureHrCovLength := funcCureHrCov.GetLength();
  Result.funcCureLrCov := PDouble(funcCureLrCov.data);
  Result.funcCureLrCovLength := funcCureLrCov.GetLength();
  Result.funcCureChildrenCov := PDouble(funcCureChildrenCov.data);
  Result.funcCureChildrenCovLength := funcCureChildrenCov.GetLength();
  Result.funcCureReduceInf := funcCureReduceInf;
  Result.funcCureReduceInfLength := 1;
  Result.funcCureReduceMort := funcCureReduceMort;
  Result.funcCureReduceMortLength := 1;
  Result.funcCureDuration := funcCureDuration;
  Result.funcCureDurationLength := 1;
end;
...
begin;
  ...
  Result.propCuredAll := PDouble(propCuredAll.data);
  Result.propCuredAllLength := propCuredAll.GetLength();
  Result.propCuredRg := PDouble(propCuredRg.data);
  Result.propCuredRgLength := propCuredRg.GetLength();
  Result.propCuredChildren := PDouble(propCuredChildren.data);
  Result.propCuredChildrenLength := propCuredChildren.GetLength();
  Result.propCuredNeonates := PDouble(propCuredNeonates.data);
  Result.propCuredNeonatesLength := propCuredNeonates.GetLength();
  Result.propFuncCuredHr := PDouble(propFuncCuredHr.data);
  Result.propFuncCuredHrLength := propFuncCuredHr.GetLength();
  Result.propFuncCuredLr := PDouble(propFuncCuredLr.data);
  Result.propFuncCuredLrLength := propFuncCuredLr.GetLength();
  Result.propFuncCuredChildren := PDouble(propFuncCuredChildren.data);
  Result.propFuncCuredChildrenLength := propFuncCuredChildren.GetLength();
  Result.propTherapeuticallyVaccinated := PDouble(propTherapeuticallyVaccinated.data);
  Result.propTherapeuticallyVaccinatedLength := propTherapeuticallyVaccinated.GetLength();
  Result.curedProp := PDouble(curedProp.data);
  Result.curedPropLength := curedProp.GetLength();
  Result.totalNewCures := PDouble(totalNewCures.data);
  Result.totalNewCuresLength := totalNewCures.GetLength();
end;
...
begin;
  ...
  cotrimVal.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'cotrimVal');
  ...
  cotrimValIsPercent.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'cotrimValIsPercent');
  ...
  fertInfections.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'fertInfections');
  fertHivnpop.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'fertHivnpop');
  totalBirths.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'totalBirths');
  pbfwPrepClients.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'pbfwPrepClients');
  pbfwPrepIsPercent.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'pbfwPrepIsPercent');
  cotrimEffect.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'cotrimEffect');
...
begin;
  ...
  rnCureCoverageChildren.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'rnCureCoverageChildren');
  ...
  therapeuticVacCov.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'therapeuticVacCov');
  funcCureHrCov.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'funcCureHrCov');
  funcCureLrCov.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'funcCureLrCov');
  funcCureChildrenCov.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'funcCureChildrenCov');
end;
...
begin;
  ...
  propCuredAll.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propCuredAll');
  propCuredRg.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propCuredRg');
  propCuredChildren.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propCuredChildren');
  propCuredNeonates.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propCuredNeonates');
  propFuncCuredHr.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propFuncCuredHr');
  propFuncCuredLr.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propFuncCuredLr');
  propFuncCuredChildren.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propFuncCuredChildren');
  propTherapeuticallyVaccinated.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'propTherapeuticallyVaccinated');
