...
type
  ...
  private
    ...
    rnCureCoverage: PDouble;
    rnCureCoverageLength: Integer;
    ...
    rnVacCoverage: PDouble;
    rnVacCoverageLength: Integer;
...
type
  ...
  public
    ...
    rnCureCoverage: TGBFixedArray<Double>;
    rnCureCoverageType: Integer;
...
begin;
  ...
  Result.rnCureCoverage := PDouble(rnCureCoverage.data);
  Result.rnCureCoverageLength := rnCureCoverage.GetLength();
  ...
  Result.rnVacCoverage := PDouble(rnVacCoverage.data);
  Result.rnVacCoverageLength := rnVacCoverage.GetLength();
...
begin;
  ...
  rnCureCoverage.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'rnCureCoverage');
