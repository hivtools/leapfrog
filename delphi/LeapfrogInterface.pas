...
type
  ...
  private
    ...
    p5Infections: PDouble;
    p5InfectionsLength: Integer;
    p5HivDeaths: PDouble;
    p5HivDeathsLength: Integer;
    p5Deaths: PDouble;
    p5DeathsLength: Integer;
    medianCd4Init: PDouble;
    medianCd4InitLength: Integer;
    p5Plhiv: PDouble;
    p5PlhivLength: Integer;
    p5Art: PDouble;
    p5ArtLength: Integer;
end;
...
type
  ...
  public
    ...
    p5Infections: TGBFixedArray<Double>;
    p5HivDeaths: TGBFixedArray<Double>;
    p5Deaths: TGBFixedArray<Double>;
    medianCd4Init: TGBFixedArray<Double>;
    p5Plhiv: TGBFixedArray<Double>;
    p5Art: TGBFixedArray<Double>;
...
begin;
  ...
  Result.p5Infections := PDouble(p5Infections.data);
  Result.p5InfectionsLength := p5Infections.GetLength();
  Result.p5HivDeaths := PDouble(p5HivDeaths.data);
  Result.p5HivDeathsLength := p5HivDeaths.GetLength();
  Result.p5Deaths := PDouble(p5Deaths.data);
  Result.p5DeathsLength := p5Deaths.GetLength();
  Result.medianCd4Init := PDouble(medianCd4Init.data);
  Result.medianCd4InitLength := medianCd4Init.GetLength();
  Result.p5Plhiv := PDouble(p5Plhiv.data);
  Result.p5PlhivLength := p5Plhiv.GetLength();
  Result.p5Art := PDouble(p5Art.data);
  Result.p5ArtLength := p5Art.GetLength();
end;
...
begin;
  ...
  p5Infections.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'p5Infections');
  p5HivDeaths.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'p5HivDeaths');
  p5Deaths.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'p5Deaths');
  p5Plhiv.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'p5Plhiv');
  p5Art.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'p5Art');
end;
