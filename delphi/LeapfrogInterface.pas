...
type
  ...
  private
    ...
    pbfwPrepReceiving: PDouble;
    pbfwPrepReceivingLength: Integer;
    pbfwPrepAdherenceOral: Double;
    pbfwPrepAdherenceOralLength: Integer;
    pbfwPrepAdherenceLongActing: Double;
    pbfwPrepAdherenceLongActingLength: Integer;
    pbfwPrepClientIncidenceRatio: Double;
    pbfwPrepClientIncidenceRatioLength: Integer;
    pbfwPrepPersonYearsOral: Double;
    pbfwPrepPersonYearsOralLength: Integer;
    pbfwPrepPersonYearsLongActing: Double;
    pbfwPrepPersonYearsLongActingLength: Integer;
...
type
  ...
  public
    ...
    pbfwPrepReceiving: TGBFixedArray<Double>;
    pbfwPrepAdherenceOral: Double;
    pbfwPrepAdherenceLongActing: Double;
    pbfwPrepClientIncidenceRatio: Double;
    pbfwPrepPersonYearsOral: Double;
...
begin;
  ...
  Result.pbfwPrepReceiving := PDouble(pbfwPrepReceiving.data);
  Result.pbfwPrepReceivingLength := pbfwPrepReceiving.GetLength();
  Result.pbfwPrepAdherenceOral := pbfwPrepAdherenceOral;
  Result.pbfwPrepAdherenceOralLength := 1;
  Result.pbfwPrepAdherenceLongActing := pbfwPrepAdherenceLongActing;
  Result.pbfwPrepAdherenceLongActingLength := 1;
  Result.pbfwPrepClientIncidenceRatio := pbfwPrepClientIncidenceRatio;
  Result.pbfwPrepClientIncidenceRatioLength := 1;
  Result.pbfwPrepPersonYearsOral := pbfwPrepPersonYearsOral;
  Result.pbfwPrepPersonYearsOralLength := 1;
  Result.pbfwPrepPersonYearsLongActing := pbfwPrepPersonYearsLongActing;
  Result.pbfwPrepPersonYearsLongActingLength := 1;
...
begin;
  ...
  pbfwPrepReceiving.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'pbfwPrepReceiving');
