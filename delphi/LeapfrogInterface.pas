...
type
  ...
  private
    ...
    transMultM: Double;
    transMultMLength: Integer;
    transHivF: Double;
    transHivFLength: Integer;
    transMultSti: Double;
    transMultStiLength: Integer;
    condomEffect: Double;
    condomEffectLength: Integer;
...
begin;
  ...
  Result.transMultM := transMultM;
  Result.transMultMLength := 1;
  Result.transHivF := transHivF;
  Result.transHivFLength := 1;
  Result.transMultSti := transMultSti;
  Result.transMultStiLength := 1;
  Result.condomEffect := condomEffect;
  Result.condomEffectLength := 1;
