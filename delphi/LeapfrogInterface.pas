...
type
  ...
  private
    ...
    epiTransMultM: Double;
    epiTransMultMLength: Integer;
    epiTransHivF: Double;
    epiTransHivFLength: Integer;
    epiTransStiMult: Double;
    epiTransStiMultLength: Integer;
...
begin;
  ...
  Result.epiTransMultM := epiTransMultM;
  Result.epiTransMultMLength := 1;
  Result.epiTransHivF := epiTransHivF;
  Result.epiTransHivFLength := 1;
  Result.epiTransStiMult := epiTransStiMult;
  Result.epiTransStiMultLength := 1;
