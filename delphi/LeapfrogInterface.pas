...
type
  ...
  public
    ...
    bBehavDur: TGBFixedArray<Double>;
...
begin;
  ...
  Result.bBehavDur := PDouble(bBehavDur.data);
  Result.bBehavDurLength := bBehavDur.GetLength();
...
begin;
  ...
  bBehavDur.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'bBehavDur');
