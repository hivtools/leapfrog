...
type
  ...
  private
    ...
    prepForPregnantWomen: PDouble;
    prepForPregnantWomenLength: Integer;
    prepParameters: PDouble;
    prepParametersLength: Integer;
...
type
  ...
  public
    ...
    prepForPregnantWomen: TGBFixedArray<Double>;
    prepParameters: TGBFixedArray<Double>;
...
begin;
  ...
  Result.prepForPregnantWomen := PDouble(prepForPregnantWomen.data);
  Result.prepForPregnantWomenLength := prepForPregnantWomen.GetLength();
  Result.prepParameters := PDouble(prepParameters.data);
  Result.prepParametersLength := prepParameters.GetLength();
...
begin;
  ...
  prepForPregnantWomen.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'prepForPregnantWomen');
  prepParameters.WriteToDisk(IncludeTrailingPathDelimiter(dir) +  'prepParameters');
