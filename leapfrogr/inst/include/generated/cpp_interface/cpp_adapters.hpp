...
struct HvAdapter<Language::Cpp, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .rn_adh_treat_cov = { owned_pars.hv.rn_adh_treat_cov.data(), owned_pars.hv.rn_adh_treat_cov.shape() },
      .rn_adh_treat_reduc_mort = owned_pars.hv.rn_adh_treat_reduc_mort,
