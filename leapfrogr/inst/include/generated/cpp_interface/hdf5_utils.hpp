...
struct HcOwnedPars {
  ...
  static Pars parse_pars(
    ...
    return {
      .hc_nosocomial_infections_by_age = read_data<real_type, typename Pars::shape_hc_nosocomial_infections_by_age>(params_file, "hc_nosocomial_infections_by_age", { nda::dim<>(0, 3, 1), nda::dim<>(0, opts.proj_steps, (3)) }),
