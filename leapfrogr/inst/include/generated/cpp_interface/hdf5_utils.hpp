...
struct HvOwnedPars {
  ...
  nda::array<real_type, shape_rn_poc_effect> rn_poc_effect;
    ...
    nda::dim<0, nda::dynamic, 1>
  >;
  nda::array<real_type, shape_rn_adh_treat_cov> rn_adh_treat_cov;
  ...
  static Pars parse_pars(
    ...
    return {
      ...
      .b_incr_recruit = read_data<real_type, typename Pars::shape_b_incr_recruit>(params_file, "b_incr_recruit", { nda::dim<>(0, SS::nNS, 1), nda::dim<>(0, SS::rRG_TOTAL, (SS::nNS)) }),
      ...
      .prep_method_mix = read_data<real_type, typename Pars::shape_prep_method_mix>(params_file, "prep_method_mix", { nda::dim<>(0, SS::nNS, 1), nda::dim<>(0, SS::nPREPRG, (SS::nNS)), nda::dim<>(0, SS::nPREPIntervn, (SS::nNS) * (SS::nPREPRG)), nda::dim<>(0, opts.proj_steps, (SS::nNS) * (SS::nPREPRG) * (SS::nPREPIntervn)) }),
      ...
      .rn_coverage = read_data<real_type, typename Pars::shape_rn_coverage>(params_file, "rn_coverage", { nda::dim<>(0, SS::nIntervn, 1), nda::dim<>(0, opts.proj_steps, (SS::nIntervn)) }),
      ...
      .rn_adh_treat_cov = read_data<real_type, typename Pars::shape_rn_adh_treat_cov>(params_file, "rn_adh_treat_cov", { nda::dim<>(0, opts.proj_steps, 1) }),
      .rn_adh_treat_reduc_mort = read_data_scalar<real_type>(params_file, "rn_adh_treat_reduc_mort"),
      ...
      .rn_unit_costs = read_data<real_type, typename Pars::shape_rn_unit_costs>(params_file, "rn_unit_costs", { nda::dim<>(0, SS::nIntervn, 1), nda::dim<>(0, opts.proj_steps, (SS::nIntervn)) }),
