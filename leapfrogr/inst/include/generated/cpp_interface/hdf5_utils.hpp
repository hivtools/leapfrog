...
struct HcOwnedPars {
  ...
  static Pars parse_pars(
    ...
    return {
      .hc_nosocomial_infections_by_age = read_data<real_type, typename Pars::shape_hc_nosocomial_infections_by_age>(params_file, "hc_nosocomial_infections_by_age", { nda::dim<>(0, SS::hcAG_c, 1), nda::dim<>(0, opts.proj_steps, (SS::hcAG_c)) }),
...
struct HvOwnedPars {
  ...
  >;
  nda::array<int, shape_art_cov_num_percent> art_cov_num_percent;
  ...
  nda::array<real_type, shape_long_act_treat_cov> long_act_treat_cov;
    ...
    nda::dim<0, nda::dynamic, 1>
  >;
  nda::array<real_type, shape_art_interupt_rate> art_interupt_rate;
  ...
  static Pars parse_pars(
    ...
    return {
      ...
      .hv_impact_matrix = read_data<real_type, typename Pars::shape_hv_impact_matrix>(params_file, "hv_impact_matrix", { nda::dim<>(0, SS::nMAX_BEHAV_INTVN, 1), nda::dim<>(0, SS::nMAX_BEHAV_IMPACTS, (SS::nMAX_BEHAV_INTVN)) }),
      ...
      .art_cov_num_percent = read_data<int, typename Pars::shape_art_cov_num_percent>(params_file, "art_cov_num_percent", { nda::dim<>(0, SS::nART_NUM_PERC+1, 1) }),
      ...
      .art_interupt_rate = read_data<real_type, typename Pars::shape_art_interupt_rate>(params_file, "art_interupt_rate", { nda::dim<>(0, opts.proj_steps, 1) })
    };
  };
};
