...
struct HvConfig {
  ...
  struct Pars {
    ...
    using shape_art_interupt_rate = nda::shape<
      nda::dim<0, nda::dynamic, 1>
    >;
    nda::array_ref<real_type, shape_art_interupt_rate> art_interupt_rate;
  };
  ...
  struct Intermediate {
    ...
    using shape_cure_effect = nda::shape<
      nda::dim<0, SS::nNS, 1>
    >;
    nda::array<real_type, shape_cure_effect> cure_effect;
    ...
    void reset() {
      ...
      cure_effect.for_each_value([](real_type& x) { x = 0; });
    };
  };
