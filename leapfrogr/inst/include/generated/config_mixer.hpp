...
template<Language L, typename real_type1, MV ModelVariant1, typename ...Ts>
struct ConfigMixer<L, real_type1, ModelVariant1, Pair<true, HvConfig<real_type1, ModelVariant1>>, Ts...> {
  using real_type = real_type1;
  using ModelVariant = ModelVariant1;
  using CurrConfig = HvConfig<real_type, ModelVariant>;
  using Adapter = HvAdapter<L, real_type, ModelVariant>;
  using NextConfigMixer = ConfigMixer<L, real_type, ModelVariant, Ts...>;
  using SS = SSMixed<ModelVariant>;

  struct Pars: public NextConfigMixer::Pars {
    typename CurrConfig::Pars hv;
  };
  ...
  struct Intermediate: public NextConfigMixer::Intermediate {
    typename CurrConfig::Intermediate hv;
  ...
  struct OutputState: public NextConfigMixer::OutputState {
    typename CurrConfig::OutputState hv;
  ...
  template<typename... Args>
  static int build_output(int index, const OutputState& state, Args&&... args) {
    int new_index = Adapter::build_output(index, state.hv, std::forward<Args>(args)...);
    return NextConfigMixer::build_output(new_index, state, std::forward<Args>(args)...);
  }

  template<typename... Args>
  static int build_output_single_year(int index, const State& state, Args&&... args) {
    int new_index = Adapter::build_output_single_year(index, state.hv, std::forward<Args>(args)...);
    return NextConfigMixer::build_output_single_year(new_index, state, std::forward<Args>(args)...);
  }
...
template<Language L, typename real_type1, MV ModelVariant1, typename ...Ts>
struct ConfigMixer<L, real_type1, ModelVariant1, Pair<true, VgConfig<real_type1, ModelVariant1>>, Ts...> {
  using real_type = real_type1;
  using ModelVariant = ModelVariant1;
  using CurrConfig = VgConfig<real_type, ModelVariant>;
  using Adapter = VgAdapter<L, real_type, ModelVariant>;
  using NextConfigMixer = ConfigMixer<L, real_type, ModelVariant, Ts...>;
  using SS = SSMixed<ModelVariant>;

  struct Pars: public NextConfigMixer::Pars {
    typename CurrConfig::Pars vg;
  };
  ...
  struct Intermediate: public NextConfigMixer::Intermediate {
    typename CurrConfig::Intermediate vg;
  ...
  struct OutputState: public NextConfigMixer::OutputState {
    typename CurrConfig::OutputState vg;
  ...
  template<typename... Args>
  static int build_output(int index, const OutputState& state, Args&&... args) {
    int new_index = Adapter::build_output(index, state.vg, std::forward<Args>(args)...);
    return NextConfigMixer::build_output(new_index, state, std::forward<Args>(args)...);
  }

  template<typename... Args>
  static int build_output_single_year(int index, const State& state, Args&&... args) {
    int new_index = Adapter::build_output_single_year(index, state.vg, std::forward<Args>(args)...);
    return NextConfigMixer::build_output_single_year(new_index, state, std::forward<Args>(args)...);
  }
...
using Config = ConfigMixer<
  ...
  Pair<ModelVariant::run_goals, HvConfig<real_type, ModelVariant>>,
  Pair<ModelVariant::run_virgin, VgConfig<real_type, ModelVariant>>
>;
