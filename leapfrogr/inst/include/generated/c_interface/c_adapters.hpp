...
struct HvAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .b_incr_recruit = read_data<real_type, 2>(params.hv->b_incr_recruit, params.hv->b_incr_recruit_length, "b_incr_recruit", { nda::dim<>(0, SS::nNS, 1), nda::dim<>(0, SS::rRG_TOTAL, (SS::nNS)) }),
      ...
      .prep_method_mix = read_data<real_type, 4>(params.hv->prep_method_mix, params.hv->prep_method_mix_length, "prep_method_mix", { nda::dim<>(0, SS::nNS, 1), nda::dim<>(0, SS::nPREPRG, (SS::nNS)), nda::dim<>(0, SS::nPREPIntervn, (SS::nNS) * (SS::nPREPRG)), nda::dim<>(0, opts.proj_steps, (SS::nNS) * (SS::nPREPRG) * (SS::nPREPIntervn)) }),
      ...
      .rn_coverage = read_data<real_type, 2>(params.hv->rn_coverage, params.hv->rn_coverage_length, "rn_coverage", { nda::dim<>(0, SS::nIntervn, 1), nda::dim<>(0, opts.proj_steps, (SS::nIntervn)) }),
      ...
      .rn_adh_treat_cov = read_data<real_type, 1>(params.hv->rn_adh_treat_cov, params.hv->rn_adh_treat_cov_length, "rn_adh_treat_cov", { nda::dim<>(0, opts.proj_steps, 1) }),
      .rn_adh_treat_reduc_mort = params.hv->rn_adh_treat_reduc_mort,
      ...
      .rn_unit_costs = read_data<real_type, 2>(params.hv->rn_unit_costs, params.hv->rn_unit_costs_length, "rn_unit_costs", { nda::dim<>(0, SS::nIntervn, 1), nda::dim<>(0, opts.proj_steps, (SS::nIntervn)) }),
