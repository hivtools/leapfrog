...
struct HcAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      .hc_nosocomial_infections_by_age = read_data<real_type, 2>(params.hc->hc_nosocomial_infections_by_age, params.hc->hc_nosocomial_infections_by_age_length, "hc_nosocomial_infections_by_age", { nda::dim<>(0, SS::hcAG_c, 1), nda::dim<>(0, opts.proj_steps, (SS::hcAG_c)) }),
...
struct HvAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .hv_impact_matrix = read_data<real_type, 2>(params.hv->hv_impact_matrix, params.hv->hv_impact_matrix_length, "hv_impact_matrix", { nda::dim<>(0, SS::nMAX_BEHAV_INTVN, 1), nda::dim<>(0, SS::nMAX_BEHAV_IMPACTS, (SS::nMAX_BEHAV_INTVN)) }),
      ...
      .art_cov_num_percent = read_data<int, 1>(params.hv->art_cov_num_percent, params.hv->art_cov_num_percent_length, "art_cov_num_percent", { nda::dim<>(0, SS::nART_NUM_PERC+1, 1) }),
      ...
      .art_interupt_rate = read_data<real_type, 1>(params.hv->art_interupt_rate, params.hv->art_interupt_rate_length, "art_interupt_rate", { nda::dim<>(0, opts.proj_steps, 1) })
    };
  };
