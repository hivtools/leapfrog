...
struct HcAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      .nosocomial_infections_by_age = read_data<real_type, 2>(params.hc->nosocomial_infections_by_age, params.hc->nosocomial_infections_by_age_length, "nosocomial_infections_by_age", { nda::dim<>(0, 3, 1), nda::dim<>(0, opts.proj_steps, (3)) }),
