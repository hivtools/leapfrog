...
struct HvAdapter<Language::R, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      ...
      .rn_adh_treat_reduc_mort = Rcpp::as<real_type>(data["rn_adh_treat_reduc_mort"]),
  ...
  static int build_output(
    ...
    names[index + 19] = "mult_no_art";
    ret[index + 19] = r_mult_no_art;
    ...
    names[index + 20] = "mult_art";
    ret[index + 20] = r_mult_art;
    ...
    names[index + 21] = "new_inf_vrs";
    ret[index + 21] = r_new_inf_vrs;
    ...
    names[index + 22] = "new_inf_s";
    ret[index + 22] = r_new_inf_s;
    Rcpp::NumericVector r_num_people_reached(SS::nIntervnRN * output_years);
    r_num_people_reached.attr("dim") = Rcpp::IntegerVector::create(SS::nIntervnRN, output_years);
    std::copy_n(state.num_people_reached.data(), state.num_people_reached.size(), REAL(r_num_people_reached));
    names[index + 23] = "num_people_reached";
    ret[index + 23] = r_num_people_reached;
    Rcpp::NumericVector r_resources_required(SS::nIntervnRN * output_years);
    r_resources_required.attr("dim") = Rcpp::IntegerVector::create(SS::nIntervnRN, output_years);
    std::copy_n(state.resources_required.data(), state.resources_required.size(), REAL(r_resources_required));
    names[index + 24] = "resources_required";
    ret[index + 24] = r_resources_required;
    return index + output_count;
  };
  ...
  static int build_output_single_year(
    ...
    names[index + 22] = "new_inf_s";
    ret[index + 22] = r_new_inf_s;
    Rcpp::NumericVector r_num_people_reached(SS::nIntervnRN);
    r_num_people_reached.attr("dim") = Rcpp::IntegerVector::create(SS::nIntervnRN);
    std::copy_n(state.num_people_reached.data(), state.num_people_reached.size(), REAL(r_num_people_reached));
    names[index + 23] = "num_people_reached";
    ret[index + 23] = r_num_people_reached;
    Rcpp::NumericVector r_resources_required(SS::nIntervnRN);
    r_resources_required.attr("dim") = Rcpp::IntegerVector::create(SS::nIntervnRN);
    std::copy_n(state.resources_required.data(), state.resources_required.size(), REAL(r_resources_required));
    names[index + 24] = "resources_required";
    ret[index + 24] = r_resources_required;
    return index + output_count;
