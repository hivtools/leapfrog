...
struct ConfigMixer<L, real_type, ModelVariant> {
  ...
  static Pars get_pars([[maybe_unused]] Args&&... args) {
    Pars p = {}; return p;
  }
  ...
  template<typename... Args>
  static State get_initial_state([[maybe_unused]] Args&&... args) {
    State s = {}; return s;
  }
  ...
  template<typename... Args>
  static int build_output(int index, [[maybe_unused]] Args&&... args) {
    return index;
  }

  template<typename... Args>
  static int build_output_single_year(int index, [[maybe_unused]] Args&&... args) {
    return index;
  }
};
...
struct ConfigMixer<L, real_type1, ModelVariant1, Pair<true, DpConfig<real_type1, ModelVariant1>>, Ts...> {
  ...
  struct OutputState: public NextConfigMixer::OutputState {
    ...
    void save_state(const size_t idx, const State &state) {
      NextConfigMixer::OutputState::save_state(idx, state);
      dp.save_state(idx, state.dp);
    }
  };
