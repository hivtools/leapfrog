...
void fill_initial_state(T* data, nda::array<T, Shape> array) {
...
struct DpAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::State get_initial_state(
    ...
    fill_initial_state<real_type, typename Config::State::shape_p_totpop>(state.dp->p_totpop, initial_state.p_totpop);
    fill_initial_state<real_type, typename Config::State::shape_p_deaths_background_totpop>(state.dp->p_deaths_background_totpop, initial_state.p_deaths_background_totpop);
...
struct HaAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::State get_initial_state(
    ...
    typename Config::State initial_state;
    fill_initial_state<real_type, typename Config::State::shape_p_hivpop>(state.ha->p_hivpop,  initial_state.p_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_p_deaths_background_hivpop>(state.ha->p_deaths_background_hivpop, initial_state.p_deaths_background_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_h_hivpop>(state.ha->h_hivpop, initial_state.h_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_h_artpop>(state.ha->h_artpop, initial_state.h_artpop);
    fill_initial_state<real_type, typename Config::State::shape_h_hiv_deaths_no_art>(state.ha->h_hiv_deaths_no_art, initial_state.h_hiv_deaths_no_art);
    fill_initial_state<real_type, typename Config::State::shape_h_deaths_excess_nonaids_no_art>(state.ha->h_deaths_excess_nonaids_no_art, initial_state.h_deaths_excess_nonaids_no_art);
    fill_initial_state<real_type, typename Config::State::shape_p_infections>(state.ha->p_infections, initial_state.p_infections);
    fill_initial_state<real_type, typename Config::State::shape_h_hiv_deaths_art>(state.ha->h_hiv_deaths_art, initial_state.h_hiv_deaths_art);
    fill_initial_state<real_type, typename Config::State::shape_h_deaths_excess_nonaids_on_art>(state.ha->h_deaths_excess_nonaids_on_art, initial_state.h_deaths_excess_nonaids_on_art);
    fill_initial_state<real_type, typename Config::State::shape_h_art_initiation>(state.ha->h_art_initiation, initial_state.h_art_initiation);
    fill_initial_state<real_type, typename Config::State::shape_p_hiv_deaths>(state.ha->p_hiv_deaths, initial_state.p_hiv_deaths);
    fill_initial_state<real_type, typename Config::State::shape_p_deaths_excess_nonaids>(state.ha->p_deaths_excess_nonaids, initial_state.p_deaths_excess_nonaids);
    fill_initial_state<real_type, typename Config::State::shape_p_net_migration_hivpop>(state.ha->p_net_migration_hivpop, initial_state.p_net_migration_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_hiv_births_by_mat_age>(state.ha->hiv_births_by_mat_age, initial_state.hiv_births_by_mat_age);
    initial_state.hiv_births = *(state.ha->hiv_births);
    fill_initial_state<real_type, typename Config::State::shape_prevalence_15to49_hts>(state.ha->prevalence_15to49_hts, initial_state.prevalence_15to49_hts);
    fill_initial_state<real_type, typename Config::State::shape_incidence_15to49_hts>(state.ha->incidence_15to49_hts, initial_state.incidence_15to49_hts);
    fill_initial_state<real_type, typename Config::State::shape_artcoverage_15to49_hts>(state.ha->artcoverage_15to49_hts, initial_state.artcoverage_15to49_hts);
    return initial_state;
  }
...
struct HcAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::State get_initial_state(
    ...
    typename Config::State initial_state;
    fill_initial_state<real_type, typename Config::State::shape_hc1_hivpop>(state.hc->hc1_hivpop, initial_state.hc1_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_hc2_hivpop>(state.hc->hc2_hivpop, initial_state.hc2_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_hc1_artpop>(state.hc->hc1_artpop, initial_state.hc1_artpop);
    fill_initial_state<real_type, typename Config::State::shape_hc2_artpop>(state.hc->hc2_artpop, initial_state.hc2_artpop);
    fill_initial_state<real_type, typename Config::State::shape_hc1_noart_aids_deaths>(state.hc->hc1_noart_aids_deaths, initial_state.hc1_noart_aids_deaths);
    fill_initial_state<real_type, typename Config::State::shape_hc2_noart_aids_deaths>(state.hc->hc2_noart_aids_deaths, initial_state.hc2_noart_aids_deaths);
    fill_initial_state<real_type, typename Config::State::shape_hc1_art_aids_deaths>(state.hc->hc1_art_aids_deaths, initial_state.hc1_art_aids_deaths);
    fill_initial_state<real_type, typename Config::State::shape_hc2_art_aids_deaths>(state.hc->hc2_art_aids_deaths, initial_state.hc2_art_aids_deaths);
    fill_initial_state<real_type, typename Config::State::shape_hc_art_init>(state.hc->hc_art_init, initial_state.hc_art_init);
    fill_initial_state<real_type, typename Config::State::shape_hc_art_need_init>(state.hc->hc_art_need_init, initial_state.hc_art_need_init);
    initial_state.ctx_need = *(state.hc->ctx_need);
    fill_initial_state<real_type, typename Config::State::shape_infection_by_type>(state.hc->infection_by_type, initial_state.infection_by_type);
    fill_initial_state<real_type, typename Config::State::shape_mtct_by_source_tr>(state.hc->mtct_by_source_tr, initial_state.mtct_by_source_tr);
    fill_initial_state<real_type, typename Config::State::shape_mtct_by_source_women>(state.hc->mtct_by_source_women, initial_state.mtct_by_source_women);
    fill_initial_state<real_type, typename Config::State::shape_mtct_by_source_hc_infections>(state.hc->mtct_by_source_hc_infections, initial_state.mtct_by_source_hc_infections);
    fill_initial_state<real_type, typename Config::State::shape_pmtct_coverage_at_delivery>(state.hc->pmtct_coverage_at_delivery, initial_state.pmtct_coverage_at_delivery);
    return initial_state;
  }
...
struct SpAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::State get_initial_state(
    ...
    typename Config::State initial_state;
    fill_initial_state<real_type, typename Config::State::shape_p_deaths_nonaids_artpop>(state.sp->p_deaths_nonaids_artpop, initial_state.p_deaths_nonaids_artpop);
    fill_initial_state<real_type, typename Config::State::shape_p_deaths_nonaids_hivpop>(state.sp->p_deaths_nonaids_hivpop, initial_state.p_deaths_nonaids_hivpop);
    fill_initial_state<real_type, typename Config::State::shape_p_excess_deaths_nonaids_on_art>(state.sp->p_excess_deaths_nonaids_on_art, initial_state.p_excess_deaths_nonaids_on_art);
    fill_initial_state<real_type, typename Config::State::shape_p_excess_deaths_nonaids_no_art>(state.sp->p_excess_deaths_nonaids_no_art, initial_state.p_excess_deaths_nonaids_no_art);
    return initial_state;
  }
...
struct HvAdapter<Language::C, real_type, ModelVariant> {
  ...
  static Config::Pars get_pars(
    ...
    return {
      .ex_input = read_data<real_type, 2>(params.hv->ex_input, params.hv->ex_input_length, "ex_input", { nda::dim<>(0, SS::pAG, 1), nda::dim<>(0, SS::NS, (SS::pAG)) }),
      .transition_rate = read_data<real_type, 1>(params.hv->transition_rate, params.hv->transition_rate_length, "transition_rate", { nda::dim<>(0, SS::ex, 1) })
    };
  }
  ...
  static Config::State get_initial_state(
    ...
    typename Config::State initial_state;
    fill_initial_state<real_type, typename Config::State::shape_ex_output>(state.hv->ex_output, initial_state.ex_output);
    fill_initial_state<real_type, typename Config::State::shape_new_output>(state.hv->new_output, initial_state.new_output);
    return initial_state;
  }
  ...
  static int build_output(
    ...
    write_data<real_type, typename Config::OutputState::shape_ex_output>(state.ex_output, out.hv->ex_output, out.hv->ex_output_length, "ex_output");
    write_data<real_type, typename Config::OutputState::shape_new_output>(state.new_output, out.hv->new_output, out.hv->new_output_length, "new_output");
    return index + output_count;
  }
  ...
  static int build_output_single_year(
    ...
    write_data<real_type, typename Config::State::shape_ex_output>(state.ex_output, out.hv->ex_output, out.hv->ex_output_length, "ex_output");
    write_data<real_type, typename Config::State::shape_new_output>(state.new_output, out.hv->new_output, out.hv->new_output_length, "new_output");
    return index + output_count;
  }
};
