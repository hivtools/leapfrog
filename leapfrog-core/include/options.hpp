...
struct Options {
  ...
  int proj_start_year;
  int proj_end_year;
  int proj_steps; // NOLINT(modernize-use-default-member-init)

  Options(
    int hts_per_year, // NOLINT(bugprone-easily-swappable-parameters)
    int ts_art_start,
    int proj_period_int,
    int proj_start_year,
    int proj_end_year
