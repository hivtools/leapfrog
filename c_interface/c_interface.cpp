...
template <typename ModelVariant>
HRESULT fit_model_from_state(leapfrog::internal::CParams<double> &data,
                             leapfrog::internal::COptions &options,
                             leapfrog::internal::CState<double> &initial_state_data,
                             int simulation_start_year,
                             leapfrog::internal::CState<double> &out,
...
DllExport HRESULT WINAPI run_model_from_state(leapfrog::internal::CParams<double> &data,
                                              leapfrog::internal::COptions &options,
                                              leapfrog::internal::CState<double> &initial_state,
                                              int simulation_start_year,
                                              leapfrog::internal::CState<double> &out,
                                              CallbackFunction error_handler) {
  #pragma EXPORT
  return fit_model_from_state<leapfrog::Spectrum>(data, options, initial_state, simulation_start_year, out, error_handler);
}
